...
class BasicExample(Slide):
    def construct(self):
        ...
        self.play(Write(e1))
        e2 = MathTex(r"y(t+\Delta)=y+\Delta t y'+\frac{\Delta t^2}{2}y'''").move_to(e1).to_edge(LEFT).shift(DOWN)
        self.play(Write(e2))
        self.next_slide()

        e3 = MathTex(r"y(t+\Delta)=y+\Delta t f(t,y)+\frac{\Delta t^2}{2}f(t,y)}").move_to(e1).to_edge(LEFT).shift(DOWN)
        self.play(Transform(e2,e3))
        self.next_slide()

        e4 = MathTex(r"y(t+\Delta)=y+\Delta t f(t,y)+\\\frac{\Delta t^2}{2}[\frac{\partial f(t,y)}{\partial t}+f(t,y)\frac{\partial f(t,y)}{\partial y}]").move_to(e1).to_edge(LEFT).shift(DOWN*2)
        ...
        self.play(Write(e15))
        e16 = MathTex(r"a_x&=\mu v_x \sqrt{v_x^2+v_y^2+v_z^2} \\ a_y&=\mu v_y \sqrt{v_x^2+v_y^2+v_z^2} \\ a_z&=\mu v_z \sqrt{v_x^2+v_y^2+v_z^2}")
        self.play(Transform(e15,e16))
        e17 = MathTex(r"a_x&=\mu v_x \sqrt{v_x^2+v_y^2+v_z^2} \\ a_y&=\mu v_y \sqrt{v_x^2+v_y^2+v_z^2} \\ a_z&=\mu v_z \sqrt{v_x^2+v_y^2+v_z^2} \\ x'&=v_x \\ y'&=v_y \\ z'&=v_z")
        self.play(Transform(e15,e17))
        self.next_slide()

        self.play(FadeOut(e14,e15))
        e18 = Text("Case Study: Schrodinger Equation").to_edge(UP)
        self.play(Write(e18))
        e19 = MathTex(r"\frac{\partial \Psi}{\partial t}=-i h H \psi")
        self.play(Write(e19))
        e20 = MathTex(r"\frac{\partial \Psi}{\partial t}=-i h (V + \nabla^2) \Psi")
        self.play(Transform(e19,e20))
        e21 = MathTex(r"\frac{\partial \Psi}{\partial t}=-i h (V + \frac{\partial^2}{\partial^2 x} + \frac{\partial^2}{\partial^2 y}) \Psi")
        self.play(Transform(e19,e21))
