...
class BasicExample(Slide):
    def construct(self):
        ...
        self.play(Write(t))
        e1 = MathTex(r"y'=f(t,y), y(0)=y_0", color=RED).move_to(t).to_edge(LEFT).shift(DOWN*0.8)
        self.play(Write(e1))
        self.next_slide()
        
        e2 = MathTex(r"y(t+\Delta t)=y+\Delta t {{y'}}+\frac{\Delta t^2}{2}{{y''}}", color=BLUE).move_to(e1).to_edge(LEFT).shift(DOWN)
        self.play(Write(e2))
        self.next_slide()

        e3 = MathTex(r"y(t+\Delta t)=y+\Delta t {{f(t,y)}}+\frac{\Delta t^2}{2}{{f'(t,y)}}", color=BLUE).move_to(e1).to_edge(LEFT).shift(DOWN)
        self.play(Transform(e2,e3))
        self.next_slide()

        e4 = MathTex(r"y(t+\Delta t)=y+\Delta t {{f(t,y)}}+\frac{\Delta t^2}{2}{{\left[\frac{\partial f(t,y)}{\partial t}+f(t,y)\frac{\partial f(t,y)}{\partial y}\right]}}", color=BLUE).move_to(e1).to_edge(LEFT).shift(DOWN)
        self.play(Transform(e2,e4))
        self.next_slide()

        e5 = MathTex(r"k_1&=\Delta t f(t,y) \\ k_2&=\Delta t f(t+\alpha \Delta t,y+\beta k_1) \\ y(t+\Delta t)&=y+{{a}}{{k_1}}+{{b}}{{k_2}}", color=GREEN).move_to(e2).to_edge(LEFT).shift(DOWN*2)
        self.play(Write(e5))
        self.next_slide()

        e6 = MathTex(r"k_1&=\Delta t f(t,y) \\ k_2&=\Delta t f(t+\alpha \Delta t,y+\beta k_1) \\ y(t+\Delta t)&=y+{{a}}{{\Delta t f(t,y)}}+{{b}}{{\Delta t f(t+\alpha \Delta t,y+\beta k_1)}}", color=GREEN).move_to(e2).to_edge(LEFT).shift(DOWN*2)
        self.play(Transform(e5,e6))
        self.next_slide()

        e7 = MathTex(r"k_1&=\Delta t f(t,y) \\ k_2&=\Delta t f(t+\alpha \Delta t,y+\beta k_1) \\ y(t+\Delta t)&=y+{{a}}{{\Delta t f(t,y)}}+{{b}}{{\Delta t \left(f(t,y)+\Delta t f'(t,y)\right)}}", color=GREEN).move_to(e2).to_edge(LEFT).shift(DOWN*2)
        self.play(Transform(e5,e7))
        self.next_slide()

        e8 = MathTex(r"k_1&=\Delta t f(t,y) \\ k_2&=\Delta t f(t+\alpha \Delta t,y+\beta k_1) \\ y(t+\Delta t)&=y+{{(a+b)}}{{\Delta t f(t,y)}}+\\&{{}}{{\Delta t^2\left[\frac{\alpha b \partial f(t,y)}{\partial t}+\beta b f(t,y)\frac{\partial f(t,y)}{\partial y}\right]}}", color=GREEN).move_to(e2).to_edge(LEFT).shift(DOWN*2.5)
        ...
        # self.play(FadeOut(t),FadeOut(e1),FadeOut(e2),FadeOut(e5))
